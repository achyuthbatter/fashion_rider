...
<section class="shop_grid_area section-padding-80">
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-4 col-lg-3">
                <div class="shop_sidebar_area">
                    ...
                    <div class="widget brands mb-50">
                        <!-- Widget Title 2 -->
                        <form method="post" action="beauty.php">
                        <p class="widget-title2 mb-30">By Product</p>
                        <div class="widget-desc">
                            <ul>
                                <li><a href="#" name="all">All</a></li>
                                <li><a href="#" name="ks">Kits &amp; Sets</a></li>
                                <li><a href="#" name="le">Lipsticks &amp; Eyeliners</a></li>
                            </ul>
                        </div>
                        </form>
                    </div>
            ...
            <div class="row">
            <?php
                $get = "SELECT * FROM womenaccess WHERE category='Beauty' ";
