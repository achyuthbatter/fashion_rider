...
if(isset($_SESSION['womenid'])){
    $id = $_SESSION['womenid'];
    $prodimg = "SELECT * FROM products_women WHERE women_id = $id ";
    $details = "SELECT * FROM women_detail WHERE women_id = $id";
    ...
    $img = $rowimg['prod_image'];
    $name = $rowimg['product_name'];

    $category = $rowdet['category'];
    $desc = $rowdet['description'];
    $info = $rowdet['information'];
}
...
if(isset($_POST['post'])){
    ...
    $phone = $_POST['phone'];
    $msg = $_POST['msg'];
    $inscomment = "INSERT INTO comments_women(women_id,full_name,email,phoneno,msg) VALUES($id,'$fullname','$email','$phone','$msg')";
...
if(isset($_POST['cartbtn'])){
    $wproduct = $_POST['product'];
    $wquant = $_POST['quantity'];
    $wsz = $_POST['size'];

    if(empty($_SESSION['wmenquantity'])){
        $_SESSION['wmenquantity'] = array();
    } 
    if(empty($_SESSION['wmensize'])){
        $_SESSION['wmensize'] = array();
    }
    if(empty($_SESSION['wcart'])){
        $_SESSION['wcart'] = array();
    }
    array_push($_SESSION['wcart'], $wproduct);
    array_push($_SESSION['wmenquantity'], $wquant);
    array_push($_SESSION['wmensize'], $wsz);
     echo '<script type="text/javascript">
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="total-comment">
                            <div class="single-comment">
                                <?php
                                $comment = "SELECT * FROM comments_women WHERE women_id=$id";
                    ...
                    <div class="col-xl-6">
                        <div class="add-review">
                            ...
                            <form action="womendetails.php" method="post" class="main-form">
