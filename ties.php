...
<section class="shop_grid_area section-padding-80">
    <div class="container">
        <div class="row">
            ...
            <div class="row">
            <?php
                $get = "SELECT * FROM menaccess WHERE category='Ties' ";
                        ...
                        <div class="single-product col-sm-12">
                            <div class="single-product-wrapper">
                                ...
                                <div class="product-img">
                                    <img name="one" class="content-image img-fluid d-block mx-auto" src='. $rowget['imageone'] .' alt="imagetwo">
                                </div>

                                <!-- Product Description -->
                                <div class="product-description">
                                <form method="post" action="ties.php">
